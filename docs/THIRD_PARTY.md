...
| SEGMN | `Models&Datasets/SEGMN-main` | Paper: <https://arxiv.org/abs/2411.03624> | No license file or verifiable Git remote found in local archive | Supplied SEGMN architecture |
